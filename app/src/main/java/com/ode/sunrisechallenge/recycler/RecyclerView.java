...
import com.ode.sunrisechallenge.recycler.ScrollerCompat;
...
import static com.ode.sunrisechallenge.recycler.AdapterHelper.Callback;
import static com.ode.sunrisechallenge.recycler.AdapterHelper.UpdateOp;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    private class ViewFlinger implements Runnable {
        ...
        public ViewFlinger() {
            ...
            mScroller = new Scroller(getContext(), sQuinticInterpolator, true);
        }
